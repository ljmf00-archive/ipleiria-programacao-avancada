...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=STRING  file to read  (default=`/etc/services')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->file_arg = gengetopt_strdup ("/etc/services");
      ...
      switch (c)
        ...
        case 'f':	/* file to read.  */
          ...
          if (update_arg( (void *)&(args_info->file_arg), 
              ...
              &(local_args_info.file_given), optarg, 0, "/etc/services", ARG_STRING,
