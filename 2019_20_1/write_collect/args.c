...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT  numero de fluxos de execucao",
  "  -s, --size=INT     capacidade, em numero de elementos, do vetor de registo",
  "  -r, --rounds=INT   numero de rondas a serem efetuadas  (default=`3')",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->rounds_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:s:r:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* numero de fluxos de execucao.  */
          ...
          break;
        case 's':	/* capacidade, em numero de elementos, do vetor de registo.  */
          ...
          break;
        case 'r':	/* numero de rondas a serem efetuadas.  */
        
        
          if (update_arg( (void *)&(args_info->rounds_arg), 
               &(args_info->rounds_orig), &(args_info->rounds_given),
              &(local_args_info.rounds_given), optarg, 0, "3", ARG_INT,
              check_ambiguity, override, 0, 0,
              "rounds", 'r',
              additional_error))
            goto failure;
