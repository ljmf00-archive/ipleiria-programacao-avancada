...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --first=INT  primeiro numero da sequencia",
  "  -l, --last=INT   ultimo numero da sequencia",
  "  -s, --step=INT   incremento da sequencia",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->first_help = gengetopt_args_info_help[2] ;
  args_info->last_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->first_given)
    {
      fprintf (stderr, "%s: '--first' ('-f') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->last_given)
    {
      fprintf (stderr, "%s: '--last' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->step_given)
    {
      fprintf (stderr, "%s: '--step' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVf:l:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* primeiro numero da sequencia.  */
        
        
          if (update_arg( (void *)&(args_info->first_arg), 
               &(args_info->first_orig), &(args_info->first_given),
              &(local_args_info.first_given), optarg, 0, 0, ARG_INT,
          ...
          break;
        case 'l':	/* ultimo numero da sequencia.  */
