...
const char *gengetopt_args_info_help[] = {
  ...
  "  -a, --address=STRING  ipv4 address  (default=`0.0.0.0')",
  "  -p, --port=INT        socket port",
  "  -s, --server          use as a server",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->address_arg = gengetopt_strdup ("0.0.0.0");
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVa:p:s", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* ipv4 address.  */
          ...
          if (update_arg( (void *)&(args_info->address_arg), 
              ...
              &(local_args_info.address_given), optarg, 0, "0.0.0.0", ARG_STRING,
        ...
        case 'p':	/* socket port.  */
          ...
          break;
        case 's':	/* use as a server.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->server_given),
              &(local_args_info.server_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "server", 's',
              additional_error))
            goto failure;
